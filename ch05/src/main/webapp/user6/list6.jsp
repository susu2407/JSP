	...
	<body>
		...
		<table border="1">
			...
			<tr>
				...
				<td>
					<!-- 수정하고자 하는 사용자 Sequence 를  modify.jsp로 전송 -->
					<a href="./modify6.jsp?seq=<%= user6VO.getSeq() %>">수정</a>
					
					<!-- 삭제하고자 하는 사용자 Sequence 를 delete.jsp로 전송 -->
					<a href="./delete6.jsp?seq=<%= user6VO.getSeq() %>">삭제</a>
				</td>
			</tr>
			<% } %>
		</table>		
